...
class HM3DDatasetSeq(Dataset):
    ...
    def __init__(
        ...
        print("[HM3D] Scenes", len(self.scene_path_list))
    ...
    def __getitem__(self, index: int):
        ...
        first_id = ids.pop(0)
        rgb, depth, depth_mask, cam_param = self.read_frame(rgb_files, depth_files, pose_files, first_id)
        ...
        intms = [{
            ...
            "depth": [torch.stack([depth], axis=0)]*self.num_intermediate,
            "depth_mask": [torch.stack([depth_mask], axis=0)]*self.num_intermediate,
        ...
        for id in ids:
            ...
            if angle > self.adjacent_angle or distance > self.adjacent_distance:
                ...
                current_intm["depth_mask"] = [torch.stack([depth_mask], axis=0) for depth_mask in current_intm["depth_mask"]]
        ...
        if cur_len < context_max_distance:
            ...
            for i in range(pad_count):
                ...
                depth_masks.append(depth_masks[idx])
        ...
        ret = {
                ...
                "depth_mask": [torch.stack([depth_mask], axis=0) for depth_mask in depth_masks],
                "intms": intms,
