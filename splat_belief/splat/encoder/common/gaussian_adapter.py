...
class GaussianAdapter(nn.Module):
    ...
    def forward(
        ...
        sh = sh.clone().broadcast_to((*opacities.shape, 3, self.d_sh)) * self.sh_mask.detach().clone()
        ...
        origins, directions = get_world_rays(coordinates, extrinsics, intrinsics.double())
