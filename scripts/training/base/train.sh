...
CUDA_LAUNCH_BLOCKING=1 torchrun --nnodes 1 --nproc_per_node 1 --master_port $MASTER_PORT\
    ...
    dataset.root_dir=/home/ubuntu/tianmin-neurips/yyin34/codebase/structured_3d_belief/datasets/poc_dataset \
    dataset.vocab_dir=/home/ubuntu/tianmin-neurips/yyin34/codebase/structured_3d_belief/3d-belief/outputs/vocab/procthor \
    setting_name=debug \
    stage=train \
    results_folder=outputs/training/procthor_base_weights \
