#!/usr/bin/env bash
# Run 3D-Belief temporal inference / validation on the RealEstate10K sequence dataset.
...
RESULTS_FOLDER="${RESULTS_FOLDER:-outputs/inference/re10k_base}"
