...
class RoomCompletionReasoningAgent(BaseAgent):
    ...
    def imagine(self) -> Any:
        ...
        (key_output, full_output, colored_pcd), exe_time = self.world_model._imagine_along_path(
            ...
            query_label=self.current_destination_room
        )
    ...
    def calculate_metrics(self) -> Dict[str, Any]:
        ...
        metrics = {
            "recognized_objects": rendered_ret["recognized_objects"],
            "present_objects": rendered_ret["present_objects"],
            "extra_objects": rendered_ret["extra_objects"],
            "object_coverage": rendered_ret["object_coverage"],
            "precision": rendered_ret["precision"],
            "recall": rendered_ret["recall"],
            "f1_score": rendered_ret["f1_score"],
            **occupancy_metrics
        }
    ...
    def reset(self):
        ...
        self.current_destination_room = self.env_interface.task_manager.fix_object_name(self.env_interface.task_manager.current_destination_room)
