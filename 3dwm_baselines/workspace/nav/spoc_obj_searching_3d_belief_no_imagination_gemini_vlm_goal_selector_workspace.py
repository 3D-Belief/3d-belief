...
class SpocObjSearching3DBeliefNoImaginationGeminiVLMGoalSelectorWorkspace(BaseWorkspace):
...
def main(cfg: DictConfig):
    workspace = SpocObjSearching3DBeliefNoImaginationGeminiVLMGoalSelectorWorkspace(cfg)
    workspace.run()
