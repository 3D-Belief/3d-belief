...
def build_splat_model(
    ...
    if refiner is not None:
        refiner_dict = dict(refiner) if not isinstance(refiner, dict) else refiner
        refiner_cfg = GaussianRefinerCfg(**refiner_dict) if refiner_dict else GaussianRefinerCfg()
