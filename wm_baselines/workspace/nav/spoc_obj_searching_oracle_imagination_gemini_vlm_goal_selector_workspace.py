...
class SpocObjSearchingOracleImaginationGeminiVLMGoalSelectorWorkspace(BaseWorkspace):
    ...
    def run(self):
        ...
        self.agent.world_model.set_simulation(self.task_manager.stretch_controller)
...
def main(cfg: DictConfig):
    workspace = SpocObjSearchingOracleImaginationGeminiVLMGoalSelectorWorkspace(cfg)
    workspace.run()
