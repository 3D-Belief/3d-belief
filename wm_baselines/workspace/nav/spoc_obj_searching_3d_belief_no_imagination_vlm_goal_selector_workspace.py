...
class SpocObjSearching3DBeliefNoImaginationVLMGoalSelectorWorkspace(BaseWorkspace):
...
def main(cfg: DictConfig):
    workspace = SpocObjSearching3DBeliefNoImaginationVLMGoalSelectorWorkspace(cfg)
    workspace.run()
